...
var styles = StyleSheet.create({
  containerItem: {
    height:25,width:Util.size.width,alignItems:'center',justifyContent:'center',backgroundColor:'#5D4037',flexDirection:'row'
  },
  title: {
    fontSize:12,color:'white',paddingLeft:10
  },
});
